...
| [draft-0013](draft-0013-effect-shape-normalisation.md) | **DRAFT, not accepted** — evidence workup on the effect-shape vocabulary; normalise on mechanism, not on the feature that exhibits it. Takes the number `0013` on acceptance | [#76](https://github.com/eddiefiggie/srd-rules-engine/issues/76) |
