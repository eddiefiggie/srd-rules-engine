...
| 9 — p. 185's object clause unasked | **Not built**, and disclosed on `is_unoccupied` ([#459](https://github.com/eddiefiggie/srd-rules-engine/issues/459), split out of the issue [0087](0087-a-move-is-a-path-through-spaces-and-a-turn-ended-in-one-is-prone.md) closed) |
