...
| 9 — p. 185's object clause unasked | **Superseded by [0092](0092-an-object-fills-a-space-because-its-placer-said-so.md)** on 2026-09-06: `Obstruction.fills_space`, stated by the placer, is the object that fills a space, and `is_unoccupied` reads both halves. The unstated case keeps this clause's answer |
...
The object clause in row 9 did not move then and was
[#459](https://github.com/eddiefiggie/srd-rules-engine/issues/459); it is built by
[0092](0092-an-object-fills-a-space-because-its-placer-said-so.md).
